...
pub fn number<'a, 'b>(to_parse: Parsable<'a>, env_tracker: &'b Environment) -> ParseResult<'a, PTerm> {
    let shallow_parser = ShallowParser::new(&to_parse);
    let res = 'inner: {
...
pub fn line_comment<'a>(to_parse: Parsable<'a>) -> ParseResult<'a, Text> {
...
pub fn parse_expression<'a, 'b>(to_parse: Parsable<'a>, env_tracker: &'b Environment) -> ParseResult<'a, PTerm> {
    let shallow_parser = ShallowParser::new(&to_parse);
